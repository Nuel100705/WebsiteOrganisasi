...
<head>
    <meta charset="UTF-8">
    <title>Tambah Struktur - HMTI</title>
...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="relative h-72 flex items-center justify-center text-white">
        ...
        <h1 class="text-4xl font-bold z-10">Tambah Struktur</h1>
    </div>

    <!-- Form Content -->
    <div class="max-w-2xl mx-auto px-4 py-16">
        <form action="{{ route('struktur.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-2xl shadow-lg">
            @csrf

            <div class="mb-6">
                <label class="block text-gray-700 font-bold mb-2">Nama</label>
                <input type="text" name="name" class="w-full border border-gray-300 p-3 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>

            <div class="mb-6">
                <label class="block text-gray-700 font-bold mb-2">Jabatan</label>
                <input type="text" name="role" class="w-full border border-gray-300 p-3 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>

            <div class="mb-6">
                <label class="block text-gray-700 font-bold mb-2">Divisi (jika ada)</label>
                <input type="text" name="division" class="w-full border border-gray-300 p-3 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
            </div>
